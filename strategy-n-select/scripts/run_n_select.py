#!/usr/bin/env python3
"""Run deterministic N-selection and frozen-member Top1 asset voting."""
...
MEMBER_FIELDS = ["n", "candidate_id", "win_count", "slot_weight"]
MEMBER_VOTE_FIELDS = [
    "rebalance_date",
    "n",
    "member_vote_mode",
...
def build_parser() -> argparse.ArgumentParser:
    ...
    vote.add_argument("--selection-manifest", required=True, type=Path)
...
def _vote(args: argparse.Namespace) -> None:
    manifest, selection_dir = _load_and_verify_selection_manifest(args.selection_manifest)
    ...
    members_by_n = read_members(selection_dir / "members.csv")
